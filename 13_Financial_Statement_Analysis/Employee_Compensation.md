...
- Reclassify the **total** periodic pension cost: many analysts move all of it (or its operating part) appropriately, and reclassify the interest/return components to the **financing/investing** sections of the cash flow statement.
- Compare the **discount rate, expected return, and compensation growth** assumptions across firms — aggressive assumptions flatter earnings and shrink the obligation.
