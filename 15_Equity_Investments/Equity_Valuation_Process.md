...
date: 2026-06-03
status: evergreen
source: Schweser Book 3, Module 17, LOS 17.a-17.h
---

# Equity Valuation: Applications and Processes

## Value Concepts (17.a, 17.b, 17.c)
- **Intrinsic value**: the "true" value given complete information; analysts profit from **perceived mispricing** = (intrinsic − market price). Requires that the market eventually corrects.
- `Perceived mispricing = (true mispricing) + (error in the estimate of intrinsic value)`.
- **Going-concern** value (operating indefinitely) vs **liquidation** value (cease operations, sell assets). Most relevant for public companies: **fair (market) value** under the going-concern premise.

## Applications (17.d)
Stock selection, inferring market expectations, evaluating corporate events (M&A, IPOs), fairness opinions, research, planning, communicating with management.

## Industry & Competitive Analysis (17.e)
Address: industry structure (Porter's five forces), demand/supply, life-cycle stage, profitability drivers, competitive advantage and its sustainability, and the firm's strategy.
...
- **Sum-of-the-parts**: value each business segment separately and add; a **conglomerate discount** may apply (diversified firms can trade below the sum of parts due to inefficiency, opacity, or over-investment).
- **Model selection** criteria: consistent with firm characteristics (dividends? positive FCF? quality accounting?), purpose, and data availability.
