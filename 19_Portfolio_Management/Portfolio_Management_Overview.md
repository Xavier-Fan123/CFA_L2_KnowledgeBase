---
aliases: [Portfolio Management Overview, PM Overview]
tags: [CFA-L2, pm, overview]
date: 2026-06-03
status: evergreen
source: Schweser Book 5 (Modules 34-39)
---
...
## Module 37 — Multifactor Models → [[Multifactor_Models]]
APT and arbitrage; macro/fundamental/statistical models; Carhart; active risk = factor + specific.

## Module 38 — Measuring & Managing Market Risk → [[Measuring_Managing_Market_Risk]]
...
- APT needs no market portfolio; arbitrage = zero investment, zero risk, positive return.
- VaR is a minimum loss at a confidence; use CVaR for tail size; parametric VaR weak for options.
